<template><div><p>笔记结构</p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220914102401154.png" alt="image-20220914102401154"></p>
<p>官网：<a href="https://baomidou.com/" target="_blank" rel="noopener noreferrer">MyBatis-Plus (baomidou.com)<ExternalLinkIcon/></a></p>
<p>Mybatis-Plus结构</p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220914102700977.png" alt="image-20220914102700977"></p>
<h2 id="hellomybatisplus" tabindex="-1"><a class="header-anchor" href="#hellomybatisplus" aria-hidden="true">#</a> HelloMybatisPlus</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建Mapper接口（plus提供了BaseMapper，提供了一些基础的方法接口，支持泛型）</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>mapper</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在启动类上添加@MapperScan</p>
<p>将指定包下的所有接口利用动态代理机制，生成对象在Spring容器中</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>application.properties添加日志输出</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">mybatis-plus.configuration.log-impl</span><span class="token punctuation">=</span><span class="token value attr-value">org.apache.ibatis.logging.stdout.StdOutImpl</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="basemapper" tabindex="-1"><a class="header-anchor" href="#basemapper" aria-hidden="true">#</a> BaseMapper</h2>
<p>提供了一系列对单表操作的基本操作</p>
...
* 
* */</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="update" tabindex="-1"><a class="header-anchor" href="#update" aria-hidden="true">#</a> update</h4>
...
<p>在mybatis默认的mapper文件目录下创建mapper.xml</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在userMapper接口中添加对应的方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>mapper</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="baseservice" tabindex="-1"><a class="header-anchor" href="#baseservice" aria-hidden="true">#</a> BaseService</h2>
<p>mybatis除了提供基础的Mapper，也提供了基础的Service接口<strong>IService</strong></p>
<p>和基础的Service实现类<strong>ServiceImpl</strong></p>
...
<ul>
<li>通用 Service CRUD 封装<a href="https://gitee.com/baomidou/mybatis-plus/blob/3.0/mybatis-plus-extension/src/main/java/com/baomidou/mybatisplus/extension/service/IService.java" target="_blank" rel="noopener noreferrer">IService (opens new window)<ExternalLinkIcon/></a>接口，进一步封装 CRUD 采用 <code v-pre>get 查询单行</code> <code v-pre>remove 删除</code> <code v-pre>list 查询集合</code> <code v-pre>page 分页</code> 前缀命名方式区分 <code v-pre>Mapper</code> 层避免混淆，</li>
<li>泛型 <code v-pre>T</code> 为任意实体对象</li>
<li>建议如果存在自定义通用 Service 方法的可能，请创建自己的 <code v-pre>IBaseService</code> 继承 <code v-pre>Mybatis-Plus</code> 提供的基类</li>
<li>对象 <code v-pre>Wrapper</code> 为 <a href="https://baomidou.com/01.%E6%8C%87%E5%8D%97/02.%E6%A0%B8%E5%BF%83%E5%8A%9F%E8%83%BD/wrapper.html" target="_blank" rel="noopener noreferrer">条件构造器<ExternalLinkIcon/></a></li>
</ul>
<p><strong>对于ServiceImpl，仅仅提供了一些很简单的单表操作，肯定无法满足业务需求，因此UserServiceImpl既要继承<code v-pre>ServiceImpl&lt;T&gt;</code>的一些基础方法，也要实现自定义的UserService，实现自定义的方法</strong></p>
<p>UserService</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>service</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>ServiceImpl&lt;UserMapper, User&gt;中已经实现了一些基础的Service方法</p>
<h4 id="测试——count" tabindex="-1"><a class="header-anchor" href="#测试——count" aria-hidden="true">#</a> 测试——count()</h4>
...
{8={password=123456, name=第8号user, utype=3, id=8}}
    ...
    * */</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常用注解" tabindex="-1"><a class="header-anchor" href="#常用注解" aria-hidden="true">#</a> 常用注解</h2>
<p>mybatisplus默认将实体类名称（小写）与表名称进行映射</p>
<p>将属性名与字段名进行映射</p>
<p>当两者不同时，需要用到一些注解进行映射</p>
<h4 id="tablename" tabindex="-1"><a class="header-anchor" href="#tablename" aria-hidden="true">#</a> @TableName</h4>
<p>当实体类名与表明不一致时，在实体类上添加@TableName注解，指定表名，实现实体类与表的映射</p>
<p>如果所有的表名有一个通用前缀，比如t_user,t_student。。。。mybatis也支持通过全局配置，实现映射</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">mybatis-plus.global-config.db-config.table-prefix</span><span class="token punctuation">=</span><span class="token value attr-value">t_</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这样就不用一 一配置了</p>
<h4 id="tableid" tabindex="-1"><a class="header-anchor" href="#tableid" aria-hidden="true">#</a> @TableId</h4>
<p>mybatisplus默认将实体类中的<strong>id</strong>成员遍量作为主键在实体类的映射，如果字段和成员变量不叫id，而是user_id, stu_id，就无法与主键映射，这是需要在实体类中与主键字段对应的属性上添加@TableId属性，显式指定该字段为主键的映射成员变量</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>pojo</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">User</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="value属性" tabindex="-1"><a class="header-anchor" href="#value属性" aria-hidden="true">#</a> value属性</h6>
<p>当表中列名与实体类中的属性名不一致时，需要通过value属性值，进行对应</p>
<p>当两者一致，则不用写，mybatisplus自动进行映射</p>
<h6 id="type属性" tabindex="-1"><a class="header-anchor" href="#type属性" aria-hidden="true">#</a> type属性</h6>
<p>设置主键id的填入方式类型</p>
<p>IdType是一个枚举类</p>
...
<p>如果所有的实体类的主键策略一致，也可以通过全局配置实现</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">mybatis-plus.global-config.db-config.id-type</span><span class="token punctuation">=</span><span class="token value attr-value">uuid</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果在实体类对象中设置了id，则会优先使用手动设置的id值，而不会使用自增、雪花算法等其他主键策略</p>
<h4 id="雪花算法" tabindex="-1"><a class="header-anchor" href="#雪花算法" aria-hidden="true">#</a> 雪花算法</h4>
<p>常见的数据库扩展方式：业务分库、主从复制、数据库分表</p>
<p>雪花id并不是uuid，而是结合了自增id和uuid的优势，既不会重复，也有自增特性</p>
<h6 id="数据库分表" tabindex="-1"><a class="header-anchor" href="#数据库分表" aria-hidden="true">#</a> 数据库分表</h6>
<p>单表数据量爆炸，需要对表进行拆分，一般水平拆分、垂直拆分</p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220916153811969.png" alt="image-20220916153811969"></p>
<p>######## 垂直拆分</p>
<p>适合将不常用但占用空间的字段列拆分出去</p>
<p>######## 水平拆分</p>
<p>适合拆分数据量大的表，关键在于如何根据主键id对数据进行拆分</p>
<ol>
<li>
<p>主键自增</p>
<p>比如以1000w为上限，达到1000w就分出一张表</p>
<p>分表范围的选取很重要，太小导致分表过多，太大导致单表依然数据量很大</p>
<p>优点：非常简单，数据多了只需要增加表即可，不会影响之前的数据</p>
<p>问题：分布不均匀。比如1000w数据分一张表，那么有10000010条数据时，一张表是满的，而另一张表只有10条数据</p>
</li>
<li>
<p>取模</p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220916154412762.png" alt="image-20220916154412762"></p>
</li>
<li>
<p>雪花算法</p>
<p>该算法是由推特公布的分布式主键生成算法，能够保证不同表的不同主键的不重复性，以及相同表的主键有序性</p>
<p>长度64位 Long型</p>
</li>
</ol>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220916155039773.png" alt="image-20220916155039773"></p>
<h4 id="tablefield" tabindex="-1"><a class="header-anchor" href="#tablefield" aria-hidden="true">#</a> @TableField</h4>
<h4 id="tablelogic" tabindex="-1"><a class="header-anchor" href="#tablelogic" aria-hidden="true">#</a> @TableLogic</h4>
<p>物理删除：真是删除，将对应数据从数据库删除</p>
<p>逻辑删除，假删除，记录为删除状态，数据库不会真的删除</p>
<p>逻辑删除可以进行数据恢复</p>
<p>@TableLogic  标识的属性，可以作为逻辑删除的标识属性</p>
<h2 id="条件构造器" tabindex="-1"><a class="header-anchor" href="#条件构造器" aria-hidden="true">#</a> 条件构造器</h2>
<p>Wrapper</p>
<p>用于封装条件</p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220917104532941.png" alt="image-20220917104532941"></p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220917104605310.png" alt="image-20220917104605310"></p>
<h4 id="querywrapper" tabindex="-1"><a class="header-anchor" href="#querywrapper" aria-hidden="true">#</a> QueryWrapper</h4>
<p>QueryWrapper主要是可以决定where语句的内容，提供了一系列动态生成where语句的方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
&lt;==    Updates: 9
        ...
        * */</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Wrapper默认在每一个条件之间加上and</p>
<p>如果需要加括号修改顺序，需要根据需求显式加上and()</p>
<p>并且在and()中使用lambda表达式继续添加括号内的条件</p>
<p>lambda表达式中的条件将会优先执行</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
&lt;==      Total: 5
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="组装查询" tabindex="-1"><a class="header-anchor" href="#组装查询" aria-hidden="true">#</a> 组装查询</h6>
<p>查询一部分字段，用map接收</p>
<p>selectMaps</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>虽然之前配合QueryWrapper，使用mapper.update(User, queryMapper)可以实现update操作</p>
<p>但是UpdateWrapper是专门用来update操作的</p>
<p>UpdateWrapper不仅可以设置修改的条件，还可以直接设置修改的字段</p>
<p>UpdateWrappper提供了set方法，设置修改的字段</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testUpdateWrapper</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    * */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="条件组装" tabindex="-1"><a class="header-anchor" href="#条件组装" aria-hidden="true">#</a> 条件组装</h4>
<p>很多场景中，用户选择了某一个条件，后台才会将该条件加入到sql语句的where语句中，这里模拟实现一下这种业务</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testConditionMerge</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    * */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="condition" tabindex="-1"><a class="header-anchor" href="#condition" aria-hidden="true">#</a> condition</h6>
<p>上面的例子是需要我们自己代码去判断的，QueryWrapper对于每一种条件方法，也重载了另一种实现方式，添加了一个形参condition,是Boolean类型，可以填入一系列条件判断语句，当满足条件是，该条件方法才会添加到sql语句中</p>
<p>我们用这种方法，再实现一下与上面相同的操作</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testConditionArgument</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    * */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>SQL、查询结果和上面一致</p>
<p>这种带有condition的方法实际就是把if语句内嵌实现的</p>
<h4 id="lambdaquerywrapper" tabindex="-1"><a class="header-anchor" href="#lambdaquerywrapper" aria-hidden="true">#</a> LambdaQueryWrapper</h4>
<p>使用QueryWrapper和UpdateWrapper的时候，容易出现列名写错的情况</p>
<p><strong>LambdaQueryWrapper和LambdaUpdateWrapper支持使用Lambda表达式获取字段名,代替了之前QueryWrapper和UpdateWrapper中使用字符串传入字段名的方式。</strong></p>
<p>比如User::getId</p>
<p>可以根据这个lambda表达式去获取该属性对应的表中的字段名</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<h2 id="mybatisplus插件" tabindex="-1"><a class="header-anchor" href="#mybatisplus插件" aria-hidden="true">#</a> MybatisPlus插件</h2>
<h4 id="分页插件" tabindex="-1"><a class="header-anchor" href="#分页插件" aria-hidden="true">#</a> 分页插件</h4>
<ol>
<li>
<p>配置</p>
<p>新建一个MybatisPlus配置类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>config</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    * ==>  Preparing: SELECT id,name,password,utype FROM user LIMIT ?,?
    ...
    &lt;==      Total: 5
        * */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="自定义分页功能" tabindex="-1"><a class="header-anchor" href="#自定义分页功能" aria-hidden="true">#</a> 自定义分页功能</h6>
<p>在实际业务中，对于分页的需求更加灵活，比如根据某一字段排序之后进行分页，这个时候需要自定义分页方法，实现相关业务</p>
<p>可以参照BaseMapper中的selectPage接口自定义一个返回Page的方法</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这里方法定义时，第一个参数和返回参数必须时Page类型，这样才能保证Page插件可以实现分页</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="乐观锁插件" tabindex="-1"><a class="header-anchor" href="#乐观锁插件" aria-hidden="true">#</a> 乐观锁插件</h4>
<p><strong>思想：默认在你修改数据之前，没有人修改过数据或者想要修改数据</strong></p>
<p>一般通过版本号versionId实现</p>
<p>比如，每有一次数据更新的操作，versionId加1</p>
<p><strong>最新一次更新的时候，必须满足versionId匹配（也就是在你修改之前，没有人修改过数据），才能更新，否则就无法更新</strong></p>
<p>实现流程</p>
<ol>
<li>在表中添加versionId字段</li>
<li>查询的时候，需要将versionId和信息一起取出</li>
<li>在update的时候，在Where语句中加入<strong>versionId=##{取出的versionId}</strong>，如果满足条件，就可以实现更新操作，并且要在update 的<strong>set中将versionId加1</strong></li>
</ol>
<h6 id="模拟并发修改数据" tabindex="-1"><a class="header-anchor" href="#模拟并发修改数据" aria-hidden="true">#</a> 模拟并发修改数据</h6>
<p>MybatisPlus提供的乐观锁插件帮助我们去维护versionId，不用我们自己在Sql中加入关于versionId的操作与条件</p>
<p>我们用商品表来模拟多个用户操作同一条数据的场景</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220917213908450.png" alt="image-20220917213908450"></p>
<p>最后并不是在先加50的基础上减30，而是直接在原价减30，覆盖了添加的操作</p>
<h6 id="使用乐观锁插件" tabindex="-1"><a class="header-anchor" href="#使用乐观锁插件" aria-hidden="true">#</a> 使用乐观锁插件</h6>
<ol>
<li>
<p>修改实体类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>pojo</span><span class="token punctuation">;</span>
...
<p>测试</p>
<p>同样对商品价格进行操作</p>
<p>业务代码不需要改变，插件会自动完成对versionId的更新</p>
<p>乐观锁会在第一次修改价格之后，增加versionId，这样第二次修改就不成功了，除非重新查询到最新的记录信息，在此基础上进行修改</p>
</li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testUpdateWithOptimisticLock</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    * */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="关于悲观锁" tabindex="-1"><a class="header-anchor" href="#关于悲观锁" aria-hidden="true">#</a> 关于悲观锁</h4>
<p><strong>思想：利用锁机制，默认我在操作数据的时候，其他人也可能操作数据，所以直接加锁</strong></p>
<p>MybatisPlus不提供悲观锁插件</p>
<h2 id="通用枚举" tabindex="-1"><a class="header-anchor" href="#通用枚举" aria-hidden="true">#</a> 通用枚举</h2>
<p>数据库中对于性别之类的字段，使用int存储，而java对象中可以使用枚举类型</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>enums</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="使用通用枚举" tabindex="-1"><a class="header-anchor" href="#使用通用枚举" aria-hidden="true">#</a> 使用通用枚举</h4>
<ol>
<li>
<p>添加enum包的扫描配置</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">mybatis-plus.type-enums-package</span><span class="token punctuation">=</span><span class="token value attr-value">com.mamba.enums</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>使用@EnumValue标识属性值存储进入数据库</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>mamba<span class="token punctuation">.</span>enums</span><span class="token punctuation">;</span>
...
<p>对于数据库中固定值的字段，java中可以使用枚举，然后用mybatisplus的通用枚举，即可实现枚举value与字段的映射</p>
...
<li>
<p>添加生成器代码，运行，则可以按照要求生成一个mybatisplus的模块demo</p>
</li>
</ol>
<h2 id="多数据源" tabindex="-1"><a class="header-anchor" href="#多数据源" aria-hidden="true">#</a> 多数据源</h2>
<p>场景：多库、读写分离、一主多从、混合模式....</p>
<h4 id="多库" tabindex="-1"><a class="header-anchor" href="#多库" aria-hidden="true">#</a> 多库</h4>
<ol>
<li>
<p>添加依赖</p>
...
<li>
<p>修改springboot配置文件， yml or  properties(同时存在优先读properties文件)</p>
...
<li>
<p>定义pojo， mapper，service</p>
<p>在serviceImpl类上，使用注解@DS标识操作的数据源</p>
</li>
</ol>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    * */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过日志可以发现，JDBC创建了两个SqlSession访问两个数据源</p>
<p>@DS可以作用域类，也可以作用于方法</p>
<h2 id="mybatisx插件" tabindex="-1"><a class="header-anchor" href="#mybatisx插件" aria-hidden="true">#</a> MybatisX插件</h2>
<p>虽然MybatisPlus提供了BaseMapper和ServiceImpl模板，提供了一系列基础的sql操作，提高了开发效率，但也远不能满足开发需求</p>
<p>MybatisX是IDEA的快速开发插件</p>
<h4 id="对应mapper-xml-和-mapper" tabindex="-1"><a class="header-anchor" href="#对应mapper-xml-和-mapper" aria-hidden="true">#</a> 对应mapper.xml 和 Mapper</h4>
<h4 id="代码快速生成" tabindex="-1"><a class="header-anchor" href="#代码快速生成" aria-hidden="true">#</a> 代码快速生成</h4>
<p>打开DataBase，右键表，选择MybatisX-Generator</p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220920131153472.png" alt="image-20220920131153472"></p>
<p><img src="C:\Users\mamba\AppData\Roaming\Typora\typora-user-images\image-20220920131221568.png" alt="image-20220920131221568"></p>
<h4 id="快速生成crud" tabindex="-1"><a class="header-anchor" href="#快速生成crud" aria-hidden="true">#</a> 快速生成CRUD</h4>
</div></template>
